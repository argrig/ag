...
int main(){
	...
	bool p = true;
	char zapyataya;
	//Schitivaem n,a_min,a_max,x_min,x_max
	//cin >> n >> zapyataya >> a_min >> zapyataya >> a_max >> zapyataya >> x_min >> zapyataya >> x_max;
	...
	char c = ',';
	//Vivodim s sootevetstvuyushem formate
